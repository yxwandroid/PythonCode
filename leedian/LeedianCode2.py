...
def getFeatureImage(filepath):
    ...
    if suffix == '000':
        # print('----' + suffix)
        fileName = imageNameTemp.replace(suffix, '01')
        print('----' + fileName)
    elif suffix == '001':
        # print('----' + suffix)
        fileName = imageNameTemp.replace(suffix, '02')
        print('----' + fileName)
    elif suffix == '002':
        # print('----' + suffix)
        fileName = imageNameTemp.replace(suffix, '03')
        print('----' + fileName)
    elif suffix == '011':
        # print('----' + suffix)
        fileName = imageNameTemp.replace(suffix, '04')
        print('----' + fileName)
    elif suffix == '012':
        # print('----' + suffix)
        fileName = imageNameTemp.replace(suffix, '05')
        print('----' + fileName)
    elif suffix == '013':
        # print('----' + suffix)
        fileName = imageNameTemp.replace(suffix, '00')
        print('----' + fileName)
...
gci("/Users/yangxuewu/Desktop/3014data/data")
