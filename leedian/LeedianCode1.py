...
def getFeatureImage(filepath):
    ...
    if suffix == '000':
        # print('----' + suffix)
        fileName = imageName.replace(suffix + '.jpg', '') + '0'
        print('----' + fileName)
    elif suffix == '001':
        # print('----' + suffix)
        fileName = imageName.replace(suffix + '.jpg', '') + '1'
        print('----' + fileName)
    elif suffix == '002':
        # print('----' + suffix)
        fileName = imageName.replace(suffix + '.jpg', '') + '2'
        print('----' + fileName)
    elif suffix == '011':
        # print('----' + suffix)
        fileName = imageName.replace(suffix + '.jpg', '') + '3'
        print('----' + fileName)
    elif suffix == '012':
        # print('----' + suffix)
        fileName = imageName.replace(suffix + '.jpg', '') + '4'
        print('----' + fileName)
    elif suffix == '013':
        # print('----' + suffix)
        fileName = imageName.replace(suffix + '.jpg', '') + '5'
        print('----' + fileName)
...
gci("/Users/yangxuewu/Desktop/10")
